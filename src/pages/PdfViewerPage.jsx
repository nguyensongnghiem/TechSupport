            ...
            <CardBody className="p-0 w-full flex-1 flex flex-col h-full rounded-lg overflow-hidden">
              {selectedPdf ? (
                ...
                <div className="flex items-center justify-center h-full bg-blue-50 text-blue-700 p-4 rounded-lg flex-col gap-4">
                  ...
                  <Typography variant="lead" className="text-center text-lg lg:text-xl font-medium text-blue-900">
                    Vui lòng chọn một tài liệu từ  <span className="text-blue-900 hidden lg:inline">
                    danh mục bên trái
                  </span>
