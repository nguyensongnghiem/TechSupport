...
const Header = () => {
  return (
    <header className="flex justify-between w-full items-center gap-x-4 border-b border-gray-200 bg-white px-4 py-2 shadow">
      {/* Bọc logo trong thẻ <a> để tạo liên kết */}
      <Link to="/" className="flex items-center"> {/* Thêm flex items-center để giữ ảnh và text logo thẳng hàng nếu có */}
